          ...
          <div class="bg-white shadow rounded overflow-hidden">
            <div class="px-4 pt-0 pb-4 cover">
              <div class="media align-items-end profile-head">
                <div class="profile mr-3"><img src="../../uploads/propic/<?php echo $img; ?>" alt="ProPIc" width="130" class="rounded mb-2 img-thumbnail"><a href="../editprofile.php" class="btn btn-outline-dark btn-sm btn-block">Edit profile</a></div>
...
<script>
  ...
  function clicked5() {
    ...
    Swal.fire({
      title: 'are your sure??',
      text: 'do you want to apeal this request',
      ...
      confirmButtonColor: '#ff5454',
      cancelButtonColor: '#ff5454',
      confirmButtonText: 'Apeal',
      cancelButtonText: 'Cancel'
    }).then((result) => {
      if (result.value) {
        window.location.href = "../../includes/action.php?reapply=" + value1;
      }
    })
  }
